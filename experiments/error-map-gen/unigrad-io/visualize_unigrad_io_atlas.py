...
Example:
python experiments/error-map-gen/unigrad-io/visualize_unigrad_io_atlas.py --data-dir datasets/error-map/unigrad-io/ixi --save-path assets/images/error-map/unigrad-io/unigradio_atlas_mask.png --no-show
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument(
        "--save-path",
        type=Path,
        default=Path("assets/images/error-map/unigrad-io/atlas_mask_qc.png"),
    )
    p.add_argument(
        "--slice-index",
        type=int,
